<x-layout>
    ...
    <section>
        <div class="container-fluid form-career">
            <div class="col-12 col-md-8 col-lg-4">
                <h1 class="mt-5 pt-3 txt-header-create">{{ __('ui.lavoraConNoi') }}</h1>
            </div>
            <div class="row row-form-register">
                <div class="col-12 col-md-8 col-lg-5">
                    <h2 class="mb-4 fw-bold tx-black">{{ __('ui.ciao') }} {{ Auth::user()->name }}</h2>
                    ...
                    <form action="{{ route('become.revisor') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-dark fw-bold">
                            <a class="tx-white text-decoration-none " href="{{route('become.revisor')}}">{{ __('ui.diventaRevisore') }}</a></button>
                    </form>
                </div>
                <div class="col-12 col-md-4 info-register">
                    <h3 class="mb-5">{{ __('ui.percheLavora') }}</h3>
