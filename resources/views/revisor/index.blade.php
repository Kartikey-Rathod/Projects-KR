        ...
        <div class="container container-detail">
            <div class="row">
                ...
                <div class="col-12 col-md-6 product-details-right mt-5">
                    @if ($article_to_check)
                        <h1 class="mb-3 title-show">{{ $article_to_check->title }}</h1>
                        <div class="col-detail-revisor1">
                            ...
                            <p class="fw-bold tx-black autor-revisor">{{ __('ui.autore') }}:
                    ...
                    @else
                        <div class="text-center mt-5">
                            ...
                            <a href="{{ route('home') }}"
                                class="btn btn-custom-revisor btn-lg rounded-5 text-center tx-black fw-bold mt-2">{{ __('ui.tornaHomepage') }}</a>
                        </div>
                    @endif
                </div>
            </div>
