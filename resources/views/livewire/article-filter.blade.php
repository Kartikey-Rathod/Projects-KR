    ...
    <div class="container-fluid my-2">
        <div class="row">
            ...
            <div class="col-12 col-md-3">
                <div class="container  ">
                    <div class="row ">
                        <div class="filter-sidebar p-4 rounded shadow-sm  bg-lbrown">
                            <h4 class="filter-title mb-4 fw-bold text-dark">{{ __('ui.filtraPerPrezzo') }}</h4>
                            <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-dark  mt-2 filter-btn">
                                {{ __('ui.filtra') }}
                            </button>
            ...
            <div class="col-12 col-md-8">
                <section class="container my-4 ">
                    <div class="row  justify-content-center align-items-center ">
                        ...
                        @empty
                            <h3 class="tx-black fw-bold">{{ __('ui.Non sono stati inseriti degli articoli') }}</h3>
                        @endforelse
